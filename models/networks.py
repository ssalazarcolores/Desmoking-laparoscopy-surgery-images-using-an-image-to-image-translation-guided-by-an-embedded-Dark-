...
def define_G(input_nc=4, output_nc=4, ngf=64, which_model_netG = 'unet_256', norm='batch', use_dropout=False, init_type='normal', gpu_ids=[0]):
    netG = None
...
def define_G3(input_nc=3, output_nc=3, ngf=64, which_model_netG = 'unet_256', norm='batch', use_dropout=False, init_type='normal', gpu_ids=[0]):
    netG = None
    use_gpu = len(gpu_ids) > 0
    norm_layer = get_norm_layer(norm_type=norm)
